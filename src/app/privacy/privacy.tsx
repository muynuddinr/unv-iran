            ...
            <div className="p-8">
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-700 mb-2">{t('home.privacy.contactEmail') || 'Email: sales@unv-iran.com '}</p>
                  <p className="text-gray-700 mb-2">{t('home.privacy.contactPhone') || 'Phone: +971 559025905'}</p>
                </div>
              </div>
            </div>
          </div>
