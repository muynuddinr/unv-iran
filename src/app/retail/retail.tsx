...
const Retail = () => {
  ...
  const structuredData = {
    ...
    "@type": "Product",
    "name": "Uniview Retail Security Solutions Iran",
    "description": "Advanced security camera systems and surveillance solutions for Iranian retail businesses. Complete security systems including theft prevention, customer analytics, and inventory management.",
    "brand": {
      "@type": "Brand",
      "name": "Uniview Iran",
    ...
    "keywords": "retail security Iran, store surveillance, retail CCTV, دوربین مداربسته فروشگاه, سیستم امنیتی فروشگاه, نظارت تصویری فروشگاه",
    ...
    "image": [
      "https://www.uniview-iran.ir/retail/Protecting%20Your%20Retail%20Business.webp",
      "https://www.uniview-iran.ir/retail/Fashion%20Retail.webp",
      "https://www.uniview-iran.ir/retail/Electronics%20Stores.webp"
    ]
  };
